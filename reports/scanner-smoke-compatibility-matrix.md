...
| Operating system assumptions | posix | Codex-compatible platform policy or dual-path wrappers | rewrite | planned | Evidence: `AGENTS.md`, `CLAUDE.md` |
| Shell assumptions | bash | Codex shell usage and script normalization rules | rewrite | planned | Evidence: `AGENTS.md`, `CLAUDE.md` |
