...
| multi-project-rollout | Multi-project rollout | execution | draft | 0.1 | multi-project-rollout-consistency | Coordinate scan, transform, and verification waves across multiple target repositories without losing per-project rigor. |
