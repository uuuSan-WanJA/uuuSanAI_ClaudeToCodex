...
| relevant_surface_total_lines | 1111 |
...
| path | title | lines |
| --- | --- | --- |
| `CLAUDE.md` | uuuSanAI HarnessMaker | 267 |
...
| path | title | lines |
| --- | --- | --- |
| .claude/agents/solution-transplanter.md | solution-transplanter (v1.2 — single-agent implementation) | 172 |
...
| --- | --- | --- | --- |
| AGENTS.md | uuuSanAI HarnessMaker | 35 | runtime instructions |
| applications-matrix.md | Applications Matrix | 50 | runtime instructions |
| applied-projects.md | Applied Projects | 23 | runtime instructions |
| applied-solutions.md | - | 93 | runtime instructions |
| CLAUDE.md | uuuSanAI HarnessMaker | 267 | runtime instructions |
...
| path | title | lines |
| --- | --- | --- |
| AGENTS.md | uuuSanAI HarnessMaker | 35 |
