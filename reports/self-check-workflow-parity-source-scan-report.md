...
format_version: "1.0"
status: completed
generated_at: "2026-04-21T17:47:55+09:00"
...
| relevant_surface_file_count | 10 |
| relevant_surface_total_lines | 1318 |
...
| scripts/patch-woore-fsf2-codex.ps1 | powershell | 401 | content references Claude runtime |
...
| compatibility-matrix.md | Compatibility Matrix | 31 | runtime instructions |
...
| docs/pipeline.md | Conversion Pipeline | 63 | runtime instructions |
...
| Environment mismatch | medium | Wrapper scripts | Wrapper scripts reference Claude runtime behaviors directly and will need shell-safe Codex replacements or dual-runtime branching. | `scripts/patch-harnessmaker-owner-routing.ps1`, `scripts/patch-woore-fsf2-codex.ps1` |
...
| modify | Claude-oriented wrapper scripts | Wrapper scripts reference Claude runtime behaviors directly and may need branching or replacement. | `scripts/patch-harnessmaker-owner-routing.ps1`, `scripts/patch-woore-fsf2-codex.ps1` |
| add | Codex wrapper script(s) matching existing entrypoints | Existing wrapper entrypoints imply Codex-safe entrypoints will improve parity and verification. | `scripts/patch-harnessmaker-owner-routing.ps1`, `scripts/patch-woore-fsf2-codex.ps1` |
