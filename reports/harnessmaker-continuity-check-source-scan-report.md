...
| relevant_surface_file_count | 20 |
| relevant_surface_total_lines | 1051 |
...
| path | title | lines |
| --- | --- | --- |
| `CLAUDE.md` | uuuSanAI HarnessMaker | 234 |
...
| path | title | lines |
| --- | --- | --- |
| .claude/agents/solution-transplanter.md | solution-transplanter (v1.2 — single-agent implementation) | 168 |
...
| --- | --- | --- | --- |
| AGENTS.md | uuuSanAI HarnessMaker | 16 | runtime instructions |
| applications-matrix.md | Applications Matrix | 49 | runtime instructions |
| applied-projects.md | Applied Projects | 23 | runtime instructions |
| applied-solutions.md | - | 86 | runtime instructions |
| CLAUDE.md | uuuSanAI HarnessMaker | 234 | runtime instructions |
...
| path | title | lines |
| --- | --- | --- |
| AGENTS.md | uuuSanAI HarnessMaker | 16 |
...
| Codex missing equivalent | medium | Agents | Claude agent prompts may need Codex delegation rewrites or parallel prompt files. | `.claude/agents/solution-transplanter.md` |
...
| Unclear behavior | medium | Operating system assumptions | The runtime surface mixes Windows and POSIX expectations, so the transformer must decide whether to preserve both paths or declare a supported subset. | `.claude/hooks/guard-read-path.sh`, `.claude/hooks/problems-post-edit.sh`, `.claude/hooks/problems-session-start.sh`, `.claude/hooks/solutions-post-edit.sh`, `.claude/hooks/solutions-session-start.sh`, `applications-matrix.md`, `applied-projects.md`, `CLAUDE.md`, `RunClaude.bat`, `RunClaude_Opus_No1M.bat`, `RunClaude_Opus_xhigh.bat`, `RunClaude_Sonnet.bat`, `RunCodex.bat`, `RunCodex_xhigh.bat`, `scripts/rescan-applications.sh` |
...
| add | Codex delegation prompt files or role docs | Agent roles likely need Codex-local equivalents. | `.claude/agents/solution-transplanter.md` |
